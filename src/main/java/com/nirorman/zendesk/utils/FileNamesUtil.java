...
public class FileNamesUtil {
    ...
    public static final String TEST_HOST = "nirorman.com";
    public static final String CATEGORIES = "categories";
    public static final String URL_TEMPLATE = "https://%s/api/v2/help_center/%s.json%s%s";
    ...
    public static final String MOCK_CATEGORIES_FILE_NAME = "mockCategories.html";
}
